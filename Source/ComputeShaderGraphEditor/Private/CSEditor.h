...
#include "IComputeShaderEditor.h"
...
public:
	...
	/** Destructor */
	virtual ~FComputeShaderEditor();

	/** Edits the specified ComputeShader object */
	void InitComputeShaderEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, UObject* ObjectToEdit);

	// IComputeShaderEditor
	virtual UComputeShader* GetComputeShader() const override;
...
private:
	/** The ComputeShader asset being inspected */
	UComputeShader* ComputeShader;

	/** List of open tool panels; used to ensure only one exists at any one time */
	TMap< FName, TWeakPtr<SDockableTab> > SpawnedToolPanels;

	/** New Graph Editor */
	TSharedPtr<SGraphEditor> CSGraphEditor;
