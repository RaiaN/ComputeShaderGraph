...
class IComputeShaderEditor : public FAssetEditorToolkit
{
public:
	/** Returns the ComputeShader asset inspected by the editor */
	virtual UComputeShader* GetComputeShader() const = 0;
